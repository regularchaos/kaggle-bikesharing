...
#mtrys <- tuneRF(subset(trainCasual, select = -casual), trainData$casual, mtryStart = 7, doBest = FALSE)
...
write.csv(submit,file = "bikeshare_randomForest_submission2.csv", row.names = FALSE)
